...
open class ColorFormatter {
    ...
    open func format(_ hex: String) -> UIColor {
        ...
        let red = CGFloat(Float(Int(value >> 16) & 0x0000_00FF) / 255.0)
        let green = CGFloat(Float(Int(value >> 8) & 0x0000_00FF) / 255.0)
        let blue = CGFloat(Float(Int(value) & 0x0000_00FF) / 255.0)
