...
extension matrix_float4x4 {
    ...
    public func rotatedBy(rotationAngle angle: Float, x: Float, y: Float, z: Float) -> matrix_float4x4 {
...
extension float4x4 {
    ...
    public static func makeRotate(_ radians: Float, _ x: Float, _ y: Float, _ z: Float) -> float4x4 {
