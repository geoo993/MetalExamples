...
extension Texturable {
    ...
    public func setTexture(device: MTLDevice, imageName: String) -> MTLTexture? {
    ...
    public func loadTexture(device: MTLDevice, textureName: String) -> MTLTexture? {
    ...
    public func setTexture(device: MTLDevice, image: UIImage) -> MTLTexture? {
