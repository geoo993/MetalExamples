...
extension Renderable {
    ...
    public func buildPipelineState(metalKitView: MTKView) -> MTLRenderPipelineState {
    ...
    public func buildSamplerState(device: MTLDevice) -> MTLSamplerState {
    ...
    // MARK: - Setup sampler state
    public func buildDepthStencilState(device: MTLDevice) -> MTLDepthStencilState {
