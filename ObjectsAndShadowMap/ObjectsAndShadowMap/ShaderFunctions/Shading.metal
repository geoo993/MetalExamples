...
vertex Varyings vertex_main(device ShadowVertex* verts [[buffer(0)]],
...
vertex LitVaryings lit_vertex(device ShadowVertex* verts [[buffer(0)]],
							constant ObjectData& data [[buffer(1)]],
							constant MainPass&  frame_constants [[buffer(2)]],
							uint vid [[vertex_id]])
{
...
vertex ZPassVaryings zpass_vertex_main(device ShadowVertex* verts [[buffer(0)]],
							constant ObjectData& data [[buffer(1)]],
