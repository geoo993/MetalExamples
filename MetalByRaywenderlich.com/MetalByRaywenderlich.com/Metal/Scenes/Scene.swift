...
class Scene: Node {
    ...
    var camera: Camera!
    var time: Float = 0
    var toonEdge: Float = 0
    var fireBallFreq: Float = 0
    var fireBallExplo: Float = 0
...
extension Scene {
    ...
    func createPointLight(view: MTKView, name: String, color: float3, position: float3, intensity: Float)
    ...
    func createSpotLight(view: MTKView, color: float3, position: float3, cutoff: Float, outerCutoff: Float) -> SpotLight {
